"""
Booking.com 검색 결과 → Excel 추출 스크립트
...
# 이모지·특수기호 제거 (Booking.com 숙소명에 포함될 수 있음)
...
def run(
    ...
    print(f"[2/3] Booking.com 크롤링: {query} ({checkin} ~ {checkout})")
    ...
    for i, l in enumerate(listings, 1):
        ...
        name  = l["title"][:33]
        print(f"{i:>3}  {name:<35}  {l['room_type']:<8}  KRW {l['price_per_night']:>8,}  KRW {total:>10,}  {l['rating']}")
    return out_dir
